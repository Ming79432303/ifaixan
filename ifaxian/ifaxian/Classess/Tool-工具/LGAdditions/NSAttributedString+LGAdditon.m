//
//  NSAttributedString+lgAdditon.m
//
//  Created by ming on 16/4/26.
//  Copyright © 2016年 ming All rights reserved.
//

#import "NSAttributedString+LGAdditon.h"

@implementation NSAttributedString (lgAdditon)

+ (instancetype)lg_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
