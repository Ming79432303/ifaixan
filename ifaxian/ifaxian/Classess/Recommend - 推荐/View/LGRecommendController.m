...
- (void)viewDidLoad {
    ...
    HYPageView *pageView = [[HYPageView alloc] initWithFrame:CGRectMake(0, self.navBar.lg_height, LGScreenW, LGScreenH) withTitles:@[@"发现笑话",@"发现动漫",@"发现视频",@"排行榜"] withViewControllers:@[@"LGTopicXiaoHuaController",@"LGTopicDongManController",@"LGTopicVideoController",@"LGTopicVideoController"] withParameters:nil];
